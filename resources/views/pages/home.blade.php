    ...
    <div class="w-full max-w-7xl mx-auto space-y-12 pb-12">
        ...
        <section class="relative w-full h-[400px] mt-4 rounded-2xl overflow-hidden shadow-2xl group">
            ...
            <div id="hero-slider" class="flex w-full h-full transition-transform duration-700 ease-in-out">
                ...
                <div class="min-w-full h-full relative">
                    <img src="{{ asset('images/banners/banner1.jpg') }}"
                        class="w-full h-full object-cover" alt="Banner Săn đồ công nghệ">
                    <div
                        class="absolute inset-0 bg-gradient-to-r from-black/80 to-transparent flex flex-col justify-center px-10 sm:px-20">
                        <h1 class="text-white text-3xl sm:text-5xl font-extrabold mb-4 max-w-xl leading-tight">Săn đồ công
                            nghệ<br>Giá siêu hời</h1>
                        <p class="text-gray-200 text-lg mb-8 max-w-md">Khám phá hàng ngàn điện thoại, laptop cũ chất lượng
                            cao được kiểm duyệt kỹ càng.</p>
                        <a href="#explore"
                ...
                <!-- Slide 2 -->
                <div class="min-w-full h-full relative">
                    <img src="{{ asset('images/banners/banner2.jpg') }}"
                        class="w-full h-full object-cover" alt="Banner Thời trang">
                    <div
                        class="absolute inset-0 bg-gradient-to-r from-black/80 to-transparent flex flex-col justify-center px-10 sm:px-20">
                        <h1 class="text-white text-3xl sm:text-5xl font-extrabold mb-4 max-w-xl leading-tight">Thời trang
                            phong cách<br>Thanh lý tủ đồ</h1>
                        <p class="text-gray-200 text-lg mb-8 max-w-md">Mua bán quần áo, phụ kiện đồ cũ thời trang với giá
                            cực tốt. Bảo vệ môi trường.</p>
                        <a href="#explore"
                            class="inline-block bg-primary text-on-primary font-bold py-3 px-8 rounded-full shadow hover:bg-primary-container hover:text-on-primary-container transition-colors w-max">
                            Xem bộ sưu tập
                        </a>
                ...
                <div class="min-w-full h-full relative">
                    <img src="{{ asset('images/banners/banner3.jpg') }}"
                        class="w-full h-full object-cover" alt="Banner Nội thất">
                    <div
                        class="absolute inset-0 bg-gradient-to-r from-black/80 to-transparent flex flex-col justify-center px-10 sm:px-20">
                        <h1 class="text-white text-3xl sm:text-5xl font-extrabold mb-4 max-w-xl leading-tight">Nội thất gia
                            đình<br>Tiết kiệm chi phí</h1>
            ...
            <button id="slider-prev"
                class="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center bg-white/20 hover:bg-white/40 text-white rounded-full backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity">
                <span class="material-symbols-outlined">chevron_left</span>
            </button>
            <button id="slider-next"
                class="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center bg-white/20 hover:bg-white/40 text-white rounded-full backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity">
                <span class="material-symbols-outlined">chevron_right</span>
            </button>

            <!-- Slider Indicators -->
            <div class="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2" id="slider-indicators">
                <div class="w-3 h-3 rounded-full bg-white cursor-pointer transition-colors" data-slide="0"></div>
                <div class="w-3 h-3 rounded-full bg-white/50 cursor-pointer transition-colors" data-slide="1"></div>
                <div class="w-3 h-3 rounded-full bg-white/50 cursor-pointer transition-colors" data-slide="2"></div>
            </div>
        </section>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                <div class="product-card">
                    <div class="relative">
                        <img src="https://images.unsplash.com/photo-1598327105666-5b89351cb315?auto=format&fit=crop&q=80&w=600"
                            alt="Iphone 13 Pro Max" class="product-image">
                        <span
                ...
                <div class="product-card">
                    <img src="https://images.unsplash.com/photo-1593640408182-31c70c8268f5?auto=format&fit=crop&q=80&w=600"
                        alt="Laptop Dell XPS 15" class="product-image">
                    <div class="product-info">
                ...
                <div class="product-card">
                    <img src="https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&q=80&w=600"
                        alt="Giày Sneaker Nike Air" class="product-image">
                    <div class="product-info">
                ...
                <div class="product-card">
                    <img src="https://images.unsplash.com/photo-1550226891-ef816aed4a98?auto=format&fit=crop&q=80&w=600"
                        alt="Sofa da cao cấp" class="product-image">
                    <div class="product-info">
        ...
        <section class="grid grid-cols-1 md:grid-cols-3 gap-8 py-8 border-t border-outline-variant mt-12">
            <div class="flex flex-col items-center text-center">
                ...
                <p class="text-on-surface-variant">Thương lượng giá cả và trao đổi trực tiếp với người bán nhanh chóng, an
                    toàn.</p>
            </div>
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <p class="text-on-surface-variant">Giải đáp thắc mắc, hướng dẫn đăng tin và hỗ trợ người dùng 24/7 tự động.
                </p>
            </div>
