<template>
  <div class="min-h-screen bg-surface flex flex-col font-sans text-on-surface" :class="{ 'items-center justify-center p-4': isAuthRoute }">
    ...
    <main :class="isAuthRoute ? 'w-full max-w-[480px] mt-16 relative' : 'flex-grow w-full'">
...
const isAuthRoute = computed(() => ['/login', '/register', '/forgot-password', '/reset-password'].includes(route.path));
</script>
